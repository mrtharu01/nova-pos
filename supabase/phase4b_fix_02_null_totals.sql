...
-- Fixes:
--
-- null value in column "subtotal" of relation "sales"
--
-- Cause:
--
-- The idempotency lookup used SELECT ... INTO with the same
-- variables later used to calculate the new sale.
--
-- When no previous sale existed, PostgreSQL assigned NULL to
-- those variables.
--
-- This version uses dedicated v_existing_* variables instead.
-- ============================================================
...
declare
  ...
  -- ==========================================================
  -- EXISTING SALE VARIABLES
  --
  -- These are intentionally separate.
  --
  -- The idempotency lookup must NEVER overwrite the new sale's
  -- subtotal / totals when no previous sale exists.
  -- ==========================================================
...
begin
  ...
  -- IDEMPOTENCY LOCK
  --
  -- Prevents two simultaneous requests using the same
  -- checkout key from creating duplicate receipts.
  -- ==========================================================
  ...
  -- ==========================================================
  -- EXISTING SALE LOOKUP
  --
  -- IMPORTANT:
  --
  -- This now writes ONLY into v_existing_* variables.
  -- ==========================================================
  ...
  -- EXISTING SALE FOUND
  --
  -- Return original transaction instead of creating another.
  -- ==========================================================
  ...
  -- ==========================================================
  -- LOCK INVENTORY + VALIDATE STOCK + CALCULATE SUBTOTAL
  -- ==========================================================
  ...
  loop
    ...
    -- ========================================================
    -- ALLOCATE ORDER DISCOUNT TO LINE
    -- ========================================================
