  ...
  return (
    ...
    >
      <div className="flex h-full w-full flex-col overflow-hidden bg-muted/30 md:flex-row">
        ...
        <div className="flex h-full flex-1 flex-col overflow-hidden p-4 pb-24 sm:p-6 md:pb-6">
            ...
            {categories.map(
              (category) => (
                <button
                  ...
                  className={cn(
                    "snap-start whitespace-nowrap rounded-[12px] px-5 py-2 text-sm font-semibold transition-all",
                  ...
                  {filteredProducts.map(
                    (
                      ...
                      <motion.div
                        ...
                        className="group cursor-pointer rounded-[16px] border bg-background p-2 shadow-sm transition-all hover:shadow-md hover:ring-2 hover:ring-primary/20"
                        onClick={() =>
                          handleProductClick(
                            product,
                          )
        ...
        <div className="z-10 hidden h-full w-[380px] flex-col border-l bg-background shadow-xl shadow-slate-200/50 md:flex">
          <CartContent
            cart={
              cart
            }
        ...
        <div className="pointer-events-none fixed bottom-[72px] left-0 right-0 z-30 p-4 md:hidden">
          ...
          {mobileCartOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed bottom-0 left-0 right-0 z-50 flex h-[85vh] flex-col overflow-hidden rounded-t-[32px] bg-background shadow-2xl md:hidden"
              >
          ...
          {selectedProduct?.variants.map(
            (
              ...
              <button
                ...
                className="flex w-full items-center justify-between rounded-[16px] border bg-background p-4 text-left transition-colors hover:border-primary/40 hover:bg-muted/40 disabled:cursor-not-allowed disabled:opacity-50"
              >
                <div>
